...
import 'package:eatit_v2/strings/main_strings.dart';
import 'package:eatit_v2/view_model/main_vm/main_view_model_imp.dart';
import 'package:eatit_v2/widgets/common/common_widgets.dart';
import 'package:eatit_v2/widgets/main/main_widgets.dart';
    ...
    WidgetsBinding.instance!.addPostFrameCallback((_) async{
      if(widget.box.hasData(MY_CART_KEY)){
        ...
        if(cartSave.length > 0 && cartSave.isNotEmpty){
          ...
          final listCartPassed = listCart.map((e) => CartModel.fromJson(e)).toList();

          if(listCartPassed.length>0)
            widget.cartStateController.cart.value = listCartPassed;
        }
      }
